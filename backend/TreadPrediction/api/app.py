...
def predict():
    try:
        ...
        if not all(key in data for key in ['cmc_rank', 'self_reported_circulating_supply', 'self_reported_market_cap',
                                           'added_year', 'added_month', 'last_updated_year', 'last_updated_month',
                                           'total_supply', 'circulating_supply', 'max_supply', 'num_market_pairs']):
